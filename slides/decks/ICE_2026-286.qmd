...
date: "2026-06-11"
categories: ["Semiconductors", "AI", "ESG", "SSbD"]
...
image: https://llm-wiki.footprints.cv/assets/2026_ICE-SSbD/SSbD-Semi.drawio.svg
---
...
# 🌱 Section I: The Semiconductor Twin Transition {.title-slide-section background-image="/assets/brand/Infineon-Left.png" background-size="100% auto" background-position="bottom left" background-repeat="no-repeat"}
...
::: {.callout-caution}
Screenshot (not in the paper): [Source](https://ssia.org.sg/business-connect/)
:::

![Semiconductor Business Connect 2026](/assets/2026_ICE-SSbD/ssia.org.sg-20260416.jpeg){fig-alt="SSIA" width="100%"}
...
![JRC SSbD framework](https://joint-research-centre.ec.europa.eu/sites/default/files/styles/embed_large_2x/public/2024-07/fig1.png?itok=Itu4Yb4Z){fig-alt="SSbD" width="100%"}

<small>Note. The above image is not in the paper but [sourced directly from the EC JRC site](https://joint-research-centre.ec.europa.eu/jrc-news-and-updates/designing-safer-and-more-sustainable-chemicals-and-materials-methodological-guidance-2024-07-11_en).</small>
...
<aside class="notes">
As shown in Table 1, current RegTech platforms like EcoVadis and IntegrityNext automate supplier compliance. However, these tools operate as discrete silos. They are focused heavily on corporate procurement and reporting, but remain completely disconnected from actual semiconductor factory-floor metrology and manufacturing process data. This motivates our research with objectives outlined for real-time manufacturing processes. 
</aside>
...
# 🧩 Section III: Methodology {.title-slide-section background-image="/assets/brand/Infineon-Left.png" background-size="100% auto" background-position="bottom left" background-repeat="no-repeat"}
...
1,465 total documents analyzed. 
- Web of Science: academic sample with strong keyword depth
- Scopus: active, industrial knowledge cycles contributing a substantial volume of 540 conference papers highlighting real-world, corporate R&D activity
...
::: {.subtitle}
👩‍🏫 IV.A: Institutional Affiliation
:::

*Table IV. Top Affiliations: WoS vs Scopus*

![](/assets/2026_ICE-SSbD/Table-IV.jpeg){width="75%" fig-align="center"}
...
## 👩‍🏫 IV-B: Global Collaboration Networks
...
## 👩‍🏫 IV-C: Regional Funding Distributions
...
## 👩‍🏫 IV-D: Conceptual Structure - Factorial
...
## 👩‍🏫 IV-E: Conceptual Structure - Keyword Co-occurrence Topology
...
## 🗪 V.A: Research Questions Revisited
...
![Fig 4: Safe and Sustainable by Design architecture](/assets/2026_ICE-SSbD/SSbD-Semi.drawio.svg){fig-alt="SSbD-Semi" width="100%"}

<small>*Note: Conceptual outline of Fig. 4.*</small>

<aside class="notes">
Answering all research questions, we propose this six-layer Safe and Sustainable by Design architecture. This framework acts as a conceptual scaffold to integrate factory floor metrology directly with high-level regulatory compliance, mapping data flows from molecule to market.
</aside>
...
<a href="https://www.esmc.eu/en/index.html" data-preview-link>European Semiconductor Manufacturing Company (ESMC)</a>

![](https://www.nxp.com/assets/images/en/photography/NW-ESMC-BREAKS-GROUND-ON-DRESDEN-FAB-IMG.jpg){fig-alt="ESMC" width="100%"}

<aside class="notes">
This architecture is grounded in pioneering 2026 initiatives. For instance, the IMEC netzero platform models process footprints, while the new ESMC fab in Dresden and Infineon’s Smart Power Fab are embedding these exact circular design and compliance data flows directly into advanced-node fabs.
</aside>
