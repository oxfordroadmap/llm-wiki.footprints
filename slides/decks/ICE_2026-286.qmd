...
![JRC SSbD framework](https://joint-research-centre.ec.europa.eu/sites/default/files/styles/embed_large_2x/public/2024-07/fig1.png?itok=Itu4Yb4Z)

> Note. The above image is not in the paper but [sourced directly from the EC JRC site](https://joint-research-centre.ec.europa.eu/jrc-news-and-updates/designing-safer-and-more-sustainable-chemicals-and-materials-methodological-guidance-2024-07-11_en).
...
* **RQ1: Data Interoperability**: 
* **RQ2: Scarcity Adaptation**: 
* **RQ3: Eco-Efficiency**: 
...
![Semiconductor Business Connect 2026](/assets/2026_ICE-SSbD/ssia.org.sg-20260416.jpeg)
...
Web Page (not in the paper): European Semiconductor Manufacturing Company (ESMC)

<iframe src="https://www.esmc.eu/en/index.html" width="100%" height="500px" style="border:none;"></iframe>
