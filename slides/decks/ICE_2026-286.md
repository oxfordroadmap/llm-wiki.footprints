...
## Scoping Review of AI, Metrology, and ESG in the Semiconductor Sector {style="font-size: 1.15em; white-space: nowrap;"}{.title-slide-custom background-image="/assets/brand/Infineon-Top.png" background-size="100% auto" background-position="top" background-repeat="no-repeat"}

::: {.presentation-meta}
[Presented at ICE 2026 — Main Session: Technology (TEC 3)]{.session-info}
...
<!-- Author 2 Block -->
::: {.author-card}
<!--<img src="/assets/brand/IEEE-Logo.png" class="brand-logo" alt="IEEE Logo">-->
::: {.author-avatar-group}
[Han-Teng Liao]{.name}
